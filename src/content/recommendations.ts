...
export const recommendations: Record<string, Recommendation> = {
  landing: {
    ...
    structure: ["Contexto da oferta", "Problema", "Proposta", "Benefícios", "Provas reais", "Dúvidas", "Formulário ou WhatsApp"],
  ...
  institucional: {
    ...
    structure: ["Página inicial", "Sobre", "Serviços", "Detalhes dos serviços", "Projetos reais", "Conteúdo", "Contato", "Políticas"],
  ...
  autoridade: {
    ...
    structure: ["Posicionamento", "Perfil", "Método", "Especialidades", "Projetos reais", "Artigos", "Dúvidas", "Contato"],
  ...
  orcamento: {
    ...
    structure: ["Serviços", "Áreas atendidas", "Provas reais", "Perguntas de contexto", "Confirmação", "Organização dos contatos"],
  ...
  agendamento: {
    ...
    structure: ["Serviços", "Profissional ou equipe", "Dúvidas", "Pré-atendimento", "Agenda", "Confirmação", "Contato"],
  ...
  catalogo: {
    ...
    structure: ["Página inicial", "Categorias", "Detalhes dos produtos", "Busca ou filtros", "Diferenciais", "Formulário", "WhatsApp com contexto"],
  ...
  lancamento: {
    ...
    structure: ["Apresentação", "Para quem é", "Benefícios", "Programa", "Responsáveis", "Provas reais", "Dúvidas", "Formulário de inscrição"],
  ...
  redesign: {
    ...
    structure: ["Auditoria", "Arquitetura", "Texto", "Redesign", "Desenvolvimento", "Migração", "Testes", "Mensuração"],
  ...
  funil: {
    ...
    structure: ["Site ou landing page", "Formulários", "Organização dos contatos", "Marcadores", "Notificações", "Integrações", "Mensuração", "Exportação"],
  ...
  mvp: {
    ...
    structure: ["Apresentação", "Oferta", "Benefícios", "Prova real", "Processo", "Dúvidas", "Contato", "Mensuração básica"],
    cta: "Quero definir uma primeira etapa"
  }
};

export const modules = {
  seo_local: { title: "Ser encontrado na região", body: "Organizar serviços, localização e contato pode apoiar pesquisas locais. Isso não representa garantia de posição no Google." },
