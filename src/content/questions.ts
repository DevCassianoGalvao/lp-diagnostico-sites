...
export const questions: Question[] = [
    ...
    options: [
      {
        ...
        ack: "Perfeito. A partir de agora, vamos pensar na presença digital de {negocio}.",
        blockTitle: "Uma nova experiência digital para {negocio}."
      },
      {
        id: "marca_pessoal",
        label: "Uso meu próprio nome",
        ack: "Entendi. Quando a marca é você, o site precisa transformar experiência e personalidade em confiança.",
        blockTitle: "Uma presença digital à altura do trabalho de {nome}."
      },
      {
        id: "indefinido",
  ...
  },
  {
    ...
    type: "single",
    options: [
      { id: "saude", label: "Saúde e bem-estar", ack: "Entendi. Na saúde, o site precisa transmitir segurança antes mesmo do primeiro contato.", blockTitle: "Confiança é parte do atendimento.", blockBody: "A presença digital deve explicar especialidades com clareza, reduzir dúvidas, apresentar credenciais e facilitar um contato responsável.", tags: ["nicho_saude", "autoridade"] },
      { id: "estetica", label: "Estética e beleza", ack: "Boa. Em estética, o cliente primeiro precisa confiar no processo e se enxergar na transformação.", blockTitle: "Desejo chama atenção. Confiança gera o contato.", blockBody: "O site deve unir apresentação visual, explicação segura dos serviços, provas reais e um caminho simples para avaliação ou agendamento.", tags: ["nicho_estetica", "agendamento"] },
      { id: "juridico", label: "Jurídico", ack: "Certo. No jurídico, clareza e credibilidade precisam vir antes de qualquer chamada comercial.", blockTitle: "Informação clara para decisões importantes.", blockBody: "A estrutura deve apresentar áreas de atuação, método de atendimento e conteúdo informativo com linguagem acessível.", tags: ["nicho_juridico", "autoridade"] },
      { id: "consultoria", label: "Serviços profissionais e consultoria", ack: "Perfeito. Quando conhecimento é o produto, o site precisa tornar seu valor fácil de entender.", blockTitle: "Sua experiência precisa parecer tão valiosa quanto ela é.", blockBody: "O site deve organizar problemas, método, entregáveis e provas para transformar conhecimento abstrato em uma proposta concreta.", tags: ["nicho_consultoria", "crm"] },
      { id: "servico_local", label: "Serviços locais e manutenção", ack: "Ótimo. Em serviços locais, o cliente quer respostas rápidas: o que você faz, onde atende e por que confiar.", blockTitle: "Quem precisa do serviço precisa encontrar e confiar rápido.", blockBody: "A página deve mostrar serviços, áreas atendidas, provas do trabalho e uma forma simples de pedir orçamento pelo celular.", tags: ["seo_local", "orcamento"] },
      { id: "educacao", label: "Educação, cursos e eventos", ack: "Entendi. Aqui, a página precisa transformar conteúdo em uma promessa de aprendizado clara e confiável.", blockTitle: "O público precisa entender o valor antes de se inscrever.", blockBody: "A experiência deve apresentar programa, responsáveis, público indicado, condições de participação e inscrição sem checkout na primeira versão.", tags: ["inscricao"] },
      { id: "imobiliario", label: "Imobiliário, arquitetura e construção", ack: "Boa escolha. Nesse mercado, apresentação e confiança influenciam decisões de alto valor.", blockTitle: "Projetos importantes exigem uma presença à altura.", blockBody: "O site deve valorizar imagens reais, organizar portfólio ou ofertas, explicar o processo e conduzir o visitante a uma conversa qualificada.", tags: ["portfolio", "crm"] },
  ...
  },
  {
    ...
    type: "single",
    options: [
      { id: "sem_site", label: "Ainda não tenho site", ack: "Tudo bem. Começar do zero permite construir a base certa sem carregar decisões antigas.", blockTitle: "Começar certo custa menos do que corrigir depois.", tags: ["mvp"] },
      ...
      { id: "sem_contatos", label: "Tenho site, mas quase não recebo contatos", ack: "Esse é um sinal importante: presença sem caminho de conversão vira apenas vitrine.", blockTitle: "Visita não é resultado. O próximo passo precisa estar claro.", tags: ["conversao"] },
      { id: "instagram", label: "Dependo principalmente do Instagram", ack: "O Instagram ajuda a despertar interesse, mas não deveria carregar sozinho toda a credibilidade e conversão.", blockTitle: "Rede social chama atenção. Uma estrutura própria consolida a decisão.", tags: ["rede_propria"] },
      { id: "ads_nao_converte", label: "Anuncio, mas a página não converte", ack: "Antes de aumentar o investimento, vale corrigir o caminho entre anúncio e ação.", blockTitle: "Tráfego não corrige uma página confusa.", tags: ["mensuracao"] },
      { id: "lancamento", label: "Quero lançar um novo serviço, produto ou evento", ack: "Ótimo. Um lançamento pede foco: uma oferta, uma audiência e um próximo passo principal.", blockTitle: "Uma nova oferta precisa nascer com mensagem clara.", tags: ["lancamento"] },
  ...
  },
  {
    ...
    type: "single",
    options: [
      { id: "whatsapp", label: "Gerar contatos no WhatsApp", ack: "Perfeito. O objetivo não será apenas mostrar informações, mas preparar o visitante para iniciar uma conversa.", blockTitle: "Do interesse à conversa, sem desvio.", tags: ["whatsapp"] },
      { id: "orcamento", label: "Receber pedidos de orçamento", ack: "Entendi. Um bom orçamento começa antes do contato, com informações que qualificam a solicitação.", blockTitle: "Menos pedidos vagos. Mais oportunidades com contexto.", tags: ["orcamento", "crm"] },
      { id: "agendamento", label: "Agendar atendimentos ou reuniões", ack: "Ótimo. A página precisa transformar confiança em uma agenda organizada, sem criar atrito.", blockTitle: "Clareza antes do agendamento. Organização depois do clique.", tags: ["agendamento"] },
      { id: "autoridade", label: "Fortalecer autoridade e credibilidade", ack: "Certo. A percepção de valor precisa ser construída antes da chamada para contato.", blockTitle: "Autoridade não é dizer que você é bom. É tornar a competência visível.", tags: ["autoridade"] },
      { id: "servicos", label: "Apresentar melhor meus serviços", ack: "Boa. Quando o visitante não entende rapidamente o que você faz, até um bom serviço parece difícil de contratar.", blockTitle: "Clareza transforma serviço em oferta.", tags: ["institucional"] },
      { id: "catalogo", label: "Apresentar produtos e receber pedidos", ack: "Perfeito. A prioridade será ajudar o visitante a encontrar o que procura e iniciar um pedido com clareza.", blockTitle: "Produtos organizados, informações claras e contato sem atrito.", tags: ["catalogo"] },
  ...
  },
  {
    ...
    type: "single",
    options: [
      { id: "indicacao", label: "Indicação", ack: "Indicação é um ótimo sinal de confiança. O site pode ajudar essa confiança a continuar quando a pessoa pesquisa por você.", blockTitle: "A indicação abre a porta. A presença digital confirma a escolha.", tags: ["autoridade"] },
      { id: "instagram", label: "Instagram ou redes sociais", ack: "Entendi. O site pode organizar e aprofundar o interesse que começa nas redes.", blockTitle: "O feed desperta curiosidade. A página ajuda a decidir.", tags: ["rede_propria"] },
      { id: "google", label: "Google e pesquisas", ack: "Ótimo. Quem chega pelo Google costuma trazer uma intenção mais clara.", blockTitle: "Ser encontrado é apenas o primeiro passo. A resposta precisa convencer.", tags: ["conteudo", "seo_local"] },
      { id: "trafego_pago", label: "Tráfego pago", ack: "Certo. Mensagem, velocidade, rastreamento e continuidade com o anúncio são essenciais.", blockTitle: "Cada clique precisa encontrar a promessa que o trouxe até aqui.", tags: ["mensuracao"] },
      { id: "prospeccao", label: "Prospecção ativa", ack: "Entendi. O site pode funcionar como prova e aprofundamento depois do primeiro contato.", blockTitle: "A prospecção inicia a conversa. O site reduz a desconfiança.", tags: ["autoridade"] },
      { id: "terceiros", label: "Marketplaces ou plataformas de terceiros", ack: "Esses canais podem trazer visibilidade, mas uma estrutura própria ajuda a manter uma relação direta.", blockTitle: "Use canais de terceiros sem deixar toda a sua presença depender deles.", tags: ["catalogo"] },
      { id: "sem_canal", label: "Ainda não tenho canal consistente", ack: "Sem problema. O site não cria demanda sozinho, mas pode se tornar a base certa para começar.", blockTitle: "Primeiro a base. Depois, os canais.", tags: ["mvp"] },
  ...
  },
  {
    ...
    type: "single",
    options: [
      { id: "decisao_rapida", label: "A pessoa decide rápido e chama", ack: "Ótimo. A página precisa responder o essencial sem atrasar uma decisão simples.", tags: ["whatsapp"] },
      ...
      { id: "indefinido", label: "Ainda não tenho processo definido", ack: "Tudo bem. A construção do site pode ajudar a transformar uma venda improvisada em um caminho claro.", tags: ["mvp"] }
    ]
  },
  {
    id: "level",
  ...
  },
  {
    ...
    type: "single",
    options: [
      { id: "urgente", label: "O quanto antes", ack: "Vou destacar a primeira versão essencial e o caminho mais rápido para começar com qualidade." },
      ...
      { id: "90d", label: "Entre 1 e 3 meses", ack: "Podemos pensar no projeto com antecedência e preparar materiais sem improviso." },
      { id: "pesquisa", label: "Ainda estou pesquisando", ack: "Sua recomendação vai servir como referência para comparar o que realmente importa." }
    ]
  }
];
